...
const testimonials: Testimonial[] = [
  {
    ...
    review: 'Applied through Talex and got my visa-sponsored job within 3 months. The platform is reliable and the support team is responsive.',
    rating: 5,
  },
  {
    id: 2,
    ...
    review: 'Clear process, secure payments, and genuine job listings. Talex connected me with my current employer. Highly recommended!',
    rating: 5,
  },
  {
    id: 3,
    ...
    review: 'The application tracking feature helped me stay organized. Got shortlisted within weeks and signed the contract within months.',
    rating: 5,
  },
  {
    id: 4,
    ...
    review: 'Best career decision I made. The Ksh 500 fee is worth every penny for the quality of opportunities available.',
    rating: 5,
  },
];
